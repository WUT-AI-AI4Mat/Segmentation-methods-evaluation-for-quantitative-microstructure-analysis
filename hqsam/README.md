# HQ-SAM Reproduction Code

This repository contains the HQ-SAM codebase together with the training and
evaluation scripts used for the paper reproduction experiments. For dataset
layout, checkpoint placement, and reproducible commands, see
[the root reproduction guide](../REPRODUCTION.md).

The upstream HQ-SAM documentation is kept below for model background and base
usage.
