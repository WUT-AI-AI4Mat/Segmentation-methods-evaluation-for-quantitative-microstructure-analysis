...
REFERENCE_RANKING = ['SAM2+decoder+lora', 'MicroSAM+decoder+lora', 'DeepLabV3+', 'MatSAM+decoder+lora',
                     'HQSAM+decoder+lora', 'Unet', 'SegFormer', 'SwinUnet']
    ...
    for iteration in range(1, n_iterations + 1):
        ...
        for metric in KEY_METRICS:
            if metric in rankings:
                corr = compute_spearman_correlation(rankings, REFERENCE_RANKING, metric)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-xlsx", default="Supp_3g.xlsx")
    parser.add_argument("--output-figure", default="Supp_3g.pdf")
