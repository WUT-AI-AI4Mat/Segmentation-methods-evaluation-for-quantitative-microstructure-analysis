...
def parse_args():
    parser = argparse.ArgumentParser(description="Fine-tune MatSAM with LoRA and the mask decoder.")
...
def main():
    ...
    print("Starting MatSAM LoRA and mask-decoder fine-tuning.")
    ...
    for epoch in range(EPOCHS):
        ...
        if avg_val_loss < best_val_loss:
            ...
            save_path = os.path.join(SAVE_DIR, "matsam_lora_decoder_best.pth")
